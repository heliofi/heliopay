...
```
In this example we are requesting a swap for 0.1 (10000000) SOL to USDC (mint `EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v`) and the response is a JWT that has the folloiwng payload:
```typescript
{routeToken: string}
```
