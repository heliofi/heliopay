// export const helioBaseUrl = 'https://prod.hel.io/api';
...
export const helioApiBaseUrl = 'https://test.api.hel.io';
...
export const getHelioApiBaseUrl = (): string => {
  if (helioApiBaseUrl == null) {
    throw new Error(
      'Please provide NEXT_PUBLIC_HELIO_API_BASE_URL as env variable'
    );
  }
  return helioApiBaseUrl;
};
